...
async def run_sequence(plc):
    try:
        ...
        while True:
            input_state = await plc.read_node(i02)
            if input_state:
                break
            await asyncio.sleep(0.1)
        ...
        while True:
            input_state = await plc.read_node(i03)
            if input_state:
                break
            await asyncio.sleep(0.1)
        ...
        while True:
            input_state = await plc.read_node(i04)
            if input_state:
                break
            await asyncio.sleep(0.1)
        ...
        while True:
            input_state = await plc.read_node(i05)
            if input_state:
                break
            await asyncio.sleep(0.1)
        ...
        while True:
            input_state = await plc.read_node(i06)
            if input_state:
                break
            await asyncio.sleep(0.1)
